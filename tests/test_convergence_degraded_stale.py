...
def test_suite():
    ...
    try:
        ...
        p2.send("DB 00B HEL 4 ACK p2.test 0000000000000001 OCL")
        ...
        new_a.send("DB 00G HEL 4 new-a.test 0000000000000001 OCL")
        ...
        new_a.send("DB 00G HEL 4 ACK new-a.test 0000000000000001 OCL")
        time.sleep(0.3)
        ...
        peerI.send("DB 00I HEL 4 ? 0000000000000001 OCL")
        ...
        peerI2.send("DB 00J HEL 4 ? 0000000000000001 OCL")
